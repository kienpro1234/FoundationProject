    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4 dark:bg-gray-800 dark:bg-opacity-75">
      <div className="max-h-[90vh] w-[800px] overflow-y-auto rounded-lg bg-white p-6 dark:bg-gray-900 dark:text-gray-200">
        ...
        <form className="space-y-4">
          {/* Dish Name */}
          <div>
            <label className="mb-1 block text-sm font-medium dark:text-gray-300">{food.dishName}</label>
            <input
              type="text"
          ...
          {/* Image URL */}
          <div>
            <label className="mb-1 block text-sm font-medium dark:text-gray-300">Image URL</label>
            <input
              type="text"
              className="w-full rounded-md border border-gray-300 p-2 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
              placeholder="Enter image URL"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="mb-1 block text-sm font-medium dark:text-gray-300">Price ($)</label>
              <input
                type="number"
                className="w-full rounded-md border border-gray-300 p-2 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
                placeholder="0.00"
            ...
            <div>
              <label className="mb-1 block text-sm font-medium dark:text-gray-300">Status</label>
              <select
                className="w-full rounded-md border border-gray-300 p-2 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
                name="status"
                value={formData.status}
          ...
          {/* Ingredients */}
          <div>
            <label className="mb-1 block text-sm font-medium dark:text-gray-300">Ingredients</label>
            <input
              type="text"
              className="w-full rounded-md border border-gray-300 p-2 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
              placeholder="Enter ingredients"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="mb-1 block text-sm font-medium dark:text-gray-300">Portion Size</label>
              <input
                type="number"
                className="w-full rounded-md border border-gray-300 p-2 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
                placeholder="Enter portion size"
            ...
            <div>
              <label className="mb-1 block text-sm font-medium dark:text-gray-300">Cooking Time (mins)</label>
              <input
                type="number"
                className="w-full rounded-md border border-gray-300 p-2 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
                placeholder="Enter cooking time"
          ...
          {/* Categories */}
          <div>
            <label className="mb-1 block text-sm font-medium dark:text-gray-300">Categories</label>
            <Select
              isMulti
              name="categories"
              options={categoryOptions}
              value={defaultCategories}
              onChange={handleCategoryChange}
              className="basic-multi-select dark:bg-gray-800 dark:text-gray-200"
              classNamePrefix="select"
            />
          </div>
