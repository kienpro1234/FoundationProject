    ...
    <div className={`${classes.footer}`}>
      <div className={`${classes["footer-signup"]}`}>
        <div className={`${classes["footer-signup-captions"]}`}>
          ...
          <p>
            Please enter your email to receive latest information about special
            promotions and offers from our Kitchen.
          </p>
          <div className={`${classes["footer-signup-inputContainer"]}`}>
            <input placeholder="Enter your email address" type="email" />
            <button className={`${classes["footer-signup-btn"]}`}>
              Sign up
            </button>
          </div>
        </div>
        ...
        <div className="row justify-content-center text-center">
          <div className="col-md-4">
            <div className={`${classes["footer-utils-item"]}`}>
              <img
                className="m-auto"
                src="https://static.tastykitchen.vn/images/pc/icon-support.jpg"
                alt=""
              />
              <p>SUPPORT 12/7</p>
          ...
          <div className="col-md-4">
            <div className={`${classes["footer-utils-item"]}`}>
              ...
              <p>FAST DELIVERY</p>
              <p>
                The food always remains fresh and hot when it is served to your
                home.
              </p>
            </div>
          </div>
